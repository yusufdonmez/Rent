            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Araç Detayları</h2>
                        <?php
                         if ($_SESSION['type'] == 'yonetici') {
                        ?>
                        <a href="createCar.php" class="btn btn-success pull-right">Yeni Araç Ekle</a>    
                        <?php
                         }
                        ?>
                    </div>
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        if ($row['durum'] ) {
                                        echo "<td> 'Alınabilir'</td>";
                                        }else{
                                            echo "<td> 'Kullanımda'</td>";
                                        }
                                        echo "<td>";
                                            echo "<a href='editCar.php?id=". $row['id'] ."' title='Düzenle' data-toggle='modal' data-target='#exampleModal' data-whatever='".$row['id']."'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='deleteCar.php?id=". $row['id'] ."' title='Kayıt Sil' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
